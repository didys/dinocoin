...
RESOURCES += src/qt/dinocoin.qrc src/qt/dinocoin_locale.qrc

TRANSLATIONS += src/qt/locale/dinocoin_bg.ts \
                src/qt/locale/dinocoin_de.ts \
                src/qt/locale/dinocoin_en.ts \
                src/qt/locale/dinocoin_es.ts \
                src/qt/locale/dinocoin_fi.ts \
                src/qt/locale/dinocoin_fr.ts \
                src/qt/locale/dinocoin_it.ts \
                src/qt/locale/dinocoin_ja.ts \
                src/qt/locale/dinocoin_pl.ts \
                src/qt/locale/dinocoin_pt.ts \
                src/qt/locale/dinocoin_ru.ts \
                src/qt/locale/dinocoin_sk.ts \
                src/qt/locale/dinocoin_sv.ts \
                src/qt/locale/dinocoin_vi.ts \
                src/qt/locale/dinocoin_zh_CN.ts \
                src/qt/locale/dinocoin_zh_TW.ts
