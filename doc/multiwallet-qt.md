...
In order to support loading of multiple wallets in dinocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dinocoin.cpp.
...
Changes to dinocoin.cpp
----------------------
dinocoin.cpp is the entry point into dinocoin-qt, and as such, will require some minor modifications to provide hooks for
