...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a DinoCoin address"));
#endif
...
{
    // return if URI is not valid or is no DinoCoin: URI
...
{
    // Convert dinocoin:// to dinocoin:
    //
    //    Cannot handle this later, because dinocoin:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open dinocoin.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "DinoCoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for DinoCoin.lnk
...
{
    return GetAutostartDir() / "dinocoin.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a dinocoin.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=DinoCoin\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the dinocoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add dinocoin app to startup item list
