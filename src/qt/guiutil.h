...
/** Utility functions used by the DinoCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DinoCoin addresses in monospace font
...
// Parse "dinocoin:" URI into recipient object, return true on successful parsing
