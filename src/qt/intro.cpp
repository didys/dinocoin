...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DinoCoin Core"),
     ...
     * override -datadir in the dinocoin.conf file in the default data directory
     * (to be consistent with dinocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
