                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DinoCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DinoCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dinocoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DinoCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about DinoCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DinoCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DinoCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DinoCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a DinoCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DinoCoin Core help message to get a list with possible DinoCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DinoCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DinoCoin network", "", count));
}
...
{
    QString strTitle = tr("DinoCoin Core"); // default title
