...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dinocoin Core dinocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dinocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dinocoin transaction") + "\n" +
                               "  dinocoin-tx [options] -create [commands]   " + _("Create hex-encoded dinocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dinocoin transaction
