...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemadinocoinGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemadinocoinGrant grantOutbound;
