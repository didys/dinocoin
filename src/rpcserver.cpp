...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DinoCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DinoCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dinocoin features */
        {"dinocoin", "masternode", &masternode, true, true, false},
        {"dinocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"dinocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dinocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dinocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dinocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"dinocoin", "startmasternode", &startmasternode, true, true, false},
        {"dinocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dinocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dinocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dinocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dinocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dinocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dinocoin", "mnbudget", &mnbudget, true, true, false},
        {"dinocoin", "preparebudget", &preparebudget, true, true, false},
        {"dinocoin", "submitbudget", &submitbudget, true, true, false},
        {"dinocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dinocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dinocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dinocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dinocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dinocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dinocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dinocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"dinocoin", "mnsync", &mnsync, true, true, false},
        {"dinocoin", "spork", &spork, true, true, false},
        {"dinocoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dinocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dinocoind, or the -server option to dinocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dinocoin-cli " + methodname + " " + args + "\n";
}
